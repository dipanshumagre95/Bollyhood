...
import com.app.bollyhood.databinding.FragmentSingerProfileDetailsBinding
...
@AndroidEntryPoint
class SingerProfileDetailsFragment : Fragment(),OnClickListener,ActorsProfileWorkLinkAda.onItemClick  {

    private lateinit var binding: FragmentSingerProfileDetailsBinding
    ...
    override fun onCreateView(
        ...
        binding= DataBindingUtil.inflate(layoutInflater,R.layout.fragment_singer_profile_details, container, false)
        ...
        worklinklist: ArrayList<WorkLinkProfileData>)
    {
        ...
        binding.adapter =
            ActorsProfileWorkLinkAda(requireContext(), worklinklist, this@SingerProfileDetailsFragment)
