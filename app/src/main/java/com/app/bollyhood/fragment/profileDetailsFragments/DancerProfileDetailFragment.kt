...
import com.app.bollyhood.databinding.FragmentDancerProfileDetailBinding
...
class DancerProfileDetailFragment : Fragment(),OnClickListener, ActorsProfileWorkLinkAda.onItemClick{
    ...
    private lateinit var binding: FragmentDancerProfileDetailBinding
    ...
    override fun onCreateView(
        ...
        binding= DataBindingUtil.inflate(layoutInflater,R.layout.fragment_dancer_profile_detail, container, false)
        ...
        worklinklist: ArrayList<WorkLinkProfileData>)
    {
        ...
        binding.adapter =
            ActorsProfileWorkLinkAda(requireContext(), worklinklist, this@DancerProfileDetailFragment)
