...
class MusicProducerProfileDetailFragment : Fragment(), WorkAdapter.onItemClick, OnClickListener, ImagesAdapter.onItemClick {

    lateinit var binding: FragmentMusicProducerProfileDetailBinding
    ...
    override fun onCreateView(
        ...
        binding= DataBindingUtil.inflate(layoutInflater,R.layout.fragment_music_producer_profile_detail, container, false)
    ...
    private fun initUI() {
        ...
        if (bundle!=null&&bundle?.getString(StaticData.previousFragment)=="AllActosFragment"){
            ...
            setDjProfile(singleCategoryModel)
        }
    }

    private fun setDjProfile(singleCategoryModel: SingleCategoryModel?) {
        ...
        binding.apply {
            ...
            tvsingerCategory.text = stringList.joinToString(separator = " / ")
            ...
            adapter = ImagesAdapter(requireContext(), photolist, this@MusicProducerProfileDetailFragment)
    ...
    )
    {
        ...
        val adapter =
            WorkAdapter(requireContext(), worklinklist, this@MusicProducerProfileDetailFragment)
