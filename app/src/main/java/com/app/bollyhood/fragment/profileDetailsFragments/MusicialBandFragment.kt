...
import com.app.bollyhood.databinding.FragmentMusicialBandBinding
...
@AndroidEntryPoint
class MusicialBandFragment : Fragment(), OnClickListener,ActorsProfileWorkLinkAda.onItemClick {

    private lateinit var binding: FragmentMusicialBandBinding
    ...
    override fun onCreateView(
        ...
        binding= DataBindingUtil.inflate(layoutInflater,R.layout.fragment_musicial_band, container, false)
