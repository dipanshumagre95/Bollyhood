...
import com.app.bollyhood.databinding.FragmentDjProfileDetailBinding
...
@AndroidEntryPoint
class DjProfileDetailFragment : Fragment(),OnClickListener,ActorsProfileWorkLinkAda.onItemClick {

    private lateinit var binding: FragmentDjProfileDetailBinding
    ...
    override fun onCreateView(
        ...
        binding= DataBindingUtil.inflate(layoutInflater,R.layout.fragment_dj_profile_detail, container, false)
        ...
        worklinklist: ArrayList<WorkLinkProfileData>)
    {
        ...
        binding.adapter =
            ActorsProfileWorkLinkAda(requireContext(), worklinklist, this@DjProfileDetailFragment)
