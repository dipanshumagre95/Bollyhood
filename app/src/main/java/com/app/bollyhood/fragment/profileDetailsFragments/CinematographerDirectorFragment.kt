...
import com.app.bollyhood.databinding.FragmentCinematographerDirectorBinding
...
@AndroidEntryPoint
class CinematographerDirectorFragment : Fragment(), View.OnClickListener, ActorsProfileWorkLinkAda.onItemClick {

    private lateinit var binding: FragmentCinematographerDirectorBinding
    ...
    override fun onCreateView(
        ...
        binding= DataBindingUtil.inflate(layoutInflater,R.layout.fragment_cinematographer_director, container, false)
    ...
    private fun setProfile(singleCategoryModel: SingleCategoryModel?) {
        ...
        binding.apply {
            ...
            if (singleCategoryModel?.what_i_do?.isNotEmpty() == true){
                tvWhatido.text=singleCategoryModel?.what_i_do
            }else{
                llWhatido.visibility=View.GONE
            }
            ...
            if (singleCategoryModel?.skills?.isNotEmpty()==true){
                tvSkills.text=singleCategoryModel?.skills
            }else{
                llSkills.visibility=View.GONE
            }
        ...
        worklinklist: ArrayList<WorkLinkProfileData>)
    {
        ...
        binding.adapter =
            ActorsProfileWorkLinkAda(requireContext(), worklinklist, this@CinematographerDirectorFragment)
